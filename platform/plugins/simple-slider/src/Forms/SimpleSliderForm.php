    ...
    public function setup(): void
    {
        $this
            ...
            ->add('country_id', SelectField::class, [
                'label' => trans('plugins/simple-slider::simple-slider.country'),
                'choices' => \Botble\Location\Models\Country::pluck('name', 'id')->toArray(),
                'empty_value' => trans('plugins/simple-slider::simple-slider.select_country'),
                'selected' => $this->getModel()->country_id ?? null,
            ])
