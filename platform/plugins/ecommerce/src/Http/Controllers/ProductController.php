...
class ProductController extends BaseController
{
    ...
    public function update(
        ...
        foreach ($countries as $country) {
            $price = $request->input('country_price_' . $country->id);
            $salePrice = $request->input('country_sale_price_' . $country->id);
            $inventory = $request->input('country_inventory_' . $country->id);
            ...
            if ($inventory !== null) {
                ProductCountryInventory::updateOrCreate(
                    ['product_id' => $product->id, 'country_id' => $country->id],
                    ['quantity' => $inventory]
                );
            }
