...
class TrackingSettingRequest extends Request
{
    public function rules(): array
    {
        return [
            ...
            'moengage_pixel_enabled' => $onOffRule,
            'moengage_pixel_id' => ['nullable', 'required_if:moengage_pixel_enabled,1', 'string', 'max:120'],
            'moengage_dc_id' => ['nullable', 'required_if:moengage_pixel_enabled,1', 'string', 'max:120'],
            'moengage_pixel_debug' => $onOffRule,
        ];
    }
}
