...
class Product extends BaseModel
{
    ...
    {
        return $this->hasMany(ProductCountryPrice::class, 'product_id');
    }

    public function countryInventories()
    {
        return $this->hasMany(ProductCountryInventory::class, 'product_id');
    }

    public function getQuantityAttribute($original)
    {
        $countryId = session('country_id');

        if ($countryId) {
            $inventory = $this->countryInventories
        ...
        return $original; // fallback to ec_products.quantity if no country match
    }
}
