...
trait ProductPrices
{
    ...
    {
        $countryId = getCountryDefaultId();
        $countryPrice = ProductCountryPrice::where('product_id', $this->id)->where('country_id', $countryId)->first();
    ...
    public function getSalePriceAttribute($value)
    {
        ...
        return $countryPrice->sale_price ?? 0;
    }
}
