...
use Botble\Ecommerce\AdsTracking\MoengagePixel;
...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $this->app['events']->listen(RouteMatched::class, function (): void {
            ...
            add_filter([THEME_FRONT_HEADER, 'ecommerce_checkout_header'], function ($html) {
                $pixelID = get_ecommerce_setting('moengage_pixel_id');
                $dcID = get_ecommerce_setting('moengage_dc_id');
                $debugMode = get_ecommerce_setting('moengage_pixel_debug');
                ...
                return $html . view('plugins/ecommerce::orders.partials.moengage-pixel', compact('pixelID','dcID', 'debugMode','user'))->render();
            }, 16);
        ...
        $this->app->make(MoengagePixel::class)->pushScriptsToFooter();
