        ...
        <div class="detail-info">
            ...
            <div class="clearfix product-price-cover">
                <div class="product-price primary-color float-left">
                    ...
                    @if (round($product->front_sale_price, 2) < round($product->price, 2))
            ...
            <form class="add-to-cart-form" method="POST" action="{{ route('public.cart.add-to-cart') }}" data-product-id="{{ $product->id }}" data-product-name="{{ $product->name }}" data-product-price="{{ $product->front_sale_price }}" data-product-category="{{ $product->categories->first()->name }}">
                @csrf
